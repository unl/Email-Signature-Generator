define({
	logo: "https://ucomm.unl.edu/images/email-signature/Nebraska_N_RGB_small_on_white.gif", // (optional) Absolute URL of you logo. if no logo is provided the signature will be created without one. 
	logoAlt: "Logo of the University of Nebraska &ndash; Lincoln", // Logo Alt Text. this is required if a logo image is provided
